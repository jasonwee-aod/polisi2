"""
CLI entry point for the MOH scraper.
...
from .pipeline import MOHPipeline, load_config
...
@click.option(
    "--manifest-dir",
    default="data/manifests/moh",
    show_default=True,
    envvar="MOH_MANIFEST_DIR",
...
def main(
    ...
    """MOH Government Site Scraper – archives public documents to DigitalOcean Spaces."""
