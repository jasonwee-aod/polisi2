...
class Record:
    ...
    record_id: str
    source_url: str           # API endpoint URL used to discover this item
    canonical_url: str        # Normalized document URL used for dedup
    title: str
    published_at: str         # ISO 8601 date, e.g. "2025-12-04", or ""
    agency: str
    doc_type: str             # press_release | statement | report | notice | speech | other
    content_type: str         # application/pdf | text/html | ...
    language: str             # en | ms | both
    sha256: str               # Hex digest of raw file bytes
    spaces_bucket: str
    spaces_path: str          # Object path within the bucket
    spaces_url: str           # https://<bucket>.<region>.digitaloceanspaces.com/<path>
