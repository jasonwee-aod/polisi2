...
USER_AGENT = (
    "Mozilla/5.0 (compatible; idfr-scraper/1.0; "
    "Python-Requests; +mailto:operator@example.com)"
)
REQUEST_TIMEOUT = 30  # seconds

_DEFAULT_ALLOWED_HOSTS: frozenset[str] = frozenset({"www.idfr.gov.my", "idfr.gov.my"})
...
class HTTPClient:
    ...
    def get(self, url: str, stream: bool = False) -> requests.Response:
        ...
        Always follows redirects (requests default).
        """
