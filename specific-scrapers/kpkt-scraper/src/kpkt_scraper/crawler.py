...
USER_AGENT = (
    "Mozilla/5.0 (compatible; kpkt-gov-scraper/1.0; "
...
def canonical_url(url: str) -> str:
    ...
    Normalize a URL for deduplication:
      ...
      - Strip fragment
      - Preserve path, query string as-is
    """
    parsed = urlparse(url)
    return urlunparse(
        (
...
def is_allowed_host(url: str, allowed_hosts: Optional[set[str]] = None) -> bool:
    ...
    if allowed_hosts is None:
        allowed_hosts = {"www.kpkt.gov.my", "kpkt.gov.my"}
...
class HTTPClient:
    ...
    def __init__(
        ...
        self.allowed_hosts = allowed_hosts or {"www.kpkt.gov.my", "kpkt.gov.my"}
